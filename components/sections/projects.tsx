...
const projects: Project[] = [
  {
    id: '01',
    title: 'Sales Analytics Core',
    description: 'Real-time telemetry dashboard tracking KPIs across 500+ global stores with predictive AI forecasting models.',
    category: 'BI & Analytics',
    stats: [
      { label: 'Data Points', value: '2.5M+' },
      { label: 'Latency', value: '<50ms' },
    ],
    image: '/api/placeholder/800/600', // Replace with real image
    tags: ['Power BI', 'Snowflake', 'Python'],
    color: '#10b981', // Emerald
  },
  {
    id: '02',
    title: 'Neural Segmentation',
    description: 'Unsupervised behavioral clustering using DBSCAN algorithms, driving a 35% uplift in campaign ROI.',
  ...
  },
  {
    ...
    description: 'Distributed ETL architecture reducing processing time by 70% and cutting infrastructure costs by $150k.',
    category: 'Data Engineering',
    stats: [
      { label: 'Throughput', value: '5GB/s' },
      { label: 'Cost', value: '-40%' },
    ],
    image: '/api/placeholder/800/600',
    tags: ['AWS Glue', 'Apache Airflow', 'Spark'],
    color: '#f59e0b', // Amber
  },
  {
    id: '04',
    title: 'Pred-Maint System',
    description: 'IoT Time-series forecasting model for heavy machinery failure prediction with 89% precision recall.',
    ...
    <section id="projects" className="relative bg-black py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="mt-16 flex justify-center">
           <button className="group relative px-8 py-4 rounded-full bg-white/5 border border-white/10 overflow-hidden hover:bg-white/10 transition-colors">
